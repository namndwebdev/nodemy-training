<!DOCTYPE html><html><head>
        ...
        <script src="config_303.js" type="text/javascript" charset="utf-8"></script>
        <script src="sso_303.js" type="text/javascript" charset="utf-8"></script>
        <script src="pusher.min.js"></script>
        <script src="echo.iife.js"></script>
        <script src="socketClient_303.js" type="text/javascript" charset="utf-8"></script>
        <script src="jquery_303.js" type="text/javascript" charset="utf-8"></script>
        <script src="main_303.js" type="text/javascript" charset="utf-8" defer=""></script>
        <script src="levels_303.js" type="text/javascript" charset="utf-8"></script>
        <script src="restaurant_303.js" type="text/javascript" charset="utf-8"></script>
        <script src="jquery.mCustomScrollbar.min_303.js"></script>

        <link rel="apple-touch-icon" sizes="180x180" href="../images/apple-touch-icon_303.png">
        <link rel="icon" type="image/png" sizes="32x32" href="../images/favicon_32x32_303.png">
        <link rel="icon" type="image/png" sizes="16x16" href="../images/favicon_16x16_303.png">
        <link href="../css/css.css" rel="stylesheet">
        <link href="../css/css_1.css" rel="stylesheet">
        <link rel="stylesheet" href="../css/jquery.mCustomScrollbar_303.css" type="text/css" media="screen" title="no title" charset="utf-8">
        <link rel="stylesheet" href="../css/style_303.css" type="text/css" media="screen" title="no title" charset="utf-8">
    ...
    <body>
        <div id="header">
            <a class="header-logo" href="" target="_blank" rel="noreferrer noopener">
                <img src="../images/f8_avatar_303.png" alt="">
