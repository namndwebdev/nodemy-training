<!DOCTYPE html><html><head>
        ...
        <script src="config_235.js" type="text/javascript" charset="utf-8"></script>
        <script src="sso_235.js" type="text/javascript" charset="utf-8"></script>
        <script src="pusher.min.js"></script>
        <script src="echo.iife.js"></script>
        <script src="socketClient_235.js" type="text/javascript" charset="utf-8"></script>
        <script src="jquery_235.js" type="text/javascript" charset="utf-8"></script>
        <script src="main_235.js" type="text/javascript" charset="utf-8" defer=""></script>
        <script src="levels_235.js" type="text/javascript" charset="utf-8"></script>
        <script src="restaurant_235.js" type="text/javascript" charset="utf-8"></script>
        <script src="jquery.mCustomScrollbar.min_235.js"></script>

        <link rel="apple-touch-icon" sizes="180x180" href="../images/apple-touch-icon_235.png">
        <link rel="icon" type="image/png" sizes="32x32" href="../images/favicon_32x32_235.png">
        <link rel="icon" type="image/png" sizes="16x16" href="../images/favicon_16x16_235.png">
        <link href="../css/css.css" rel="stylesheet">
        <link href="../css/css_1.css" rel="stylesheet">
        <link rel="stylesheet" href="../css/jquery.mCustomScrollbar_235.css" type="text/css" media="screen" title="no title" charset="utf-8">
        <link rel="stylesheet" href="../css/style_235.css" type="text/css" media="screen" title="no title" charset="utf-8">
    ...
    <body>
        <div id="header">
            <a class="header-logo" href="" target="_blank" rel="noreferrer noopener">
                <img src="../images/f8_avatar_235.png" alt="">
